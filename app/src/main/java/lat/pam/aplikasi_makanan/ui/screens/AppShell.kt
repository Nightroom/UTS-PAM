...
sealed class Screen(val route: String, val label: String, val icon: @Composable () -> Unit) {
    ...
    object Order : Screen("order", "Order", { Icon(Icons.Default.DateRange, contentDescription = "Order") })
...
@Composable
fun AppShell(mainNavController: NavHostController, userName: String?) {
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(Screen.Home.route) { HomeScreen(mainNavController, userName) }
